/* =============================================================
   ...
   números; el niño toca la ficha correcta en la bandeja y esta
   se coloca sola en su lugar (cada número solo tiene un lugar
   posible, así que no hay forma de "equivocarse de casilla").
